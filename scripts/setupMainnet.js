...
const kycDelegate = '0x29edF640F79E9c1322B2AcA4F1766F1ab09BcE37';
...
module.exports = async (callback) => {
  ...
  // //
  // await detherCore.setLicenceTellerPrice(web3.toHex('FR'), web3.toWei('100'));
  // console.log('licenceteller should be => ', '10', web3.fromWei(await detherCore.licenceTeller.call(web3.toHex('FR'))));
  // console.log('delay');
  // await delay(25000);
  // await detherCore.setLicenceShopPrice(web3.toHex('FR'), web3.toWei('100'));
  // console.log('licenceshop should be => ', '10', web3.fromWei(await detherCore.licenceShop.call(web3.toHex('FR'))));
  // console.log('delay');
  // await delay(25000);
  // await detherCore.setLicenceTellerPrice(web3.toHex('GI'), web3.toWei('100'));
  // console.log('licenceteller should be => ', '10', web3.fromWei(await detherCore.licenceTeller.call(web3.toHex('FR'))));
  // console.log('delay');
  // await delay(25000);
  // await detherCore.setLicenceShopPrice(web3.toHex('GI'), web3.toWei('100'));
  // console.log('licenceshop should be => ', '10', web3.fromWei(await detherCore.licenceShop.call(web3.toHex('FR'))));
  // console.log('delay');
  // await delay(25000);
  // //
