...
contract IZoneFactory {
    ...
    function zoneToGeohash(address) view public returns(bytes7);
    function geohashToZone(bytes7) view public returns(address);
    ...
    function zoneExists(bytes7 _geohash) view external returns(bool);
