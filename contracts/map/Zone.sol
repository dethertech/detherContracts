...
contract Zone is ERC223ReceivingContract, IZone {
  // ------------------------------------------------
  //
  // Library init
  //
    ...
    private
  {
    ...
    withdrawableEth[zoneOwner.addr] = withdrawableEth[zoneOwner.addr].add(funds[zoneOwner.addr]);
    funds[zoneOwner.addr] = 0;
